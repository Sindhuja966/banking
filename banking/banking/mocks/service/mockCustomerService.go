...
// Source: github.com/shikha809/banking/service (interfaces: CustomerService)
...
func (m *MockCustomerService) GetAllCustomer( ctx context.Context,arg0 string) ([]dto.CustomerResponse, *errs.AppError) {
    m.ctrl.T.Helper()
...
func (m *MockCustomerService) GetCustomer(arg0 int) (*dto.CustomerResponse, *errs.AppError) {
    m.ctrl.T.Helper()
...
func (m *MockCustomerService) CreateCustomer(req *dto.NewCustomerRequest) (*dto.NewCustomerResponse, *errs.AppError) {
    m.ctrl.T.Helper()
    ret := m.ctrl.Call(m, "CreateCustomer",req )
    ret0, _ := ret[0].(*dto.NewCustomerResponse)
    ret1, _ := ret[1].(*errs.AppError)
    return ret0, ret1
}

/// CreateCustomer indicates an expected call of GetCustomer.
func (mr *MockCustomerServiceMockRecorder) CreateCustomer(arg0 interface{}) *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateCustomer", reflect.TypeOf((*MockCustomerService)(nil).GetCustomer), arg0)
}

//save customer
func (m *MockCustomerService) SaveCustomer(Customer domain.Customer) ( *dto.CustomerResponse, *errs.AppError) {
    m.ctrl.T.Helper()
    ret := m.ctrl.Call(m, "SaveCustomer", Customer)
    ret0, _ := ret[0].(*dto.CustomerResponse)
    ret1, _ := ret[1].(*errs.AppError)
    return ret0, ret1
}
...
func (mr *MockCustomerServiceMockRecorder) SaveCustomer(arg0 interface{}) *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SaveCustomer", reflect.TypeOf((*MockCustomerService)(nil).GetCustomer), arg0)
}